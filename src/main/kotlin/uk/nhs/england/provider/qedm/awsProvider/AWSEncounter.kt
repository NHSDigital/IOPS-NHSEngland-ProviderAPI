    ...
    fun createUpdateAWSEncounter(newEncounter: Encounter): Encounter? {
        ...
        for (participant in newEncounter.participant) {
            if (participant.hasIndividual() && participant.individual.hasIdentifier()) {
                if (participant.individual.identifier.system.equals(uk.nhs.england.provider.qedm.util.FhirSystems.NHS_GMC_NUMBER)||
                    participant.individual.identifier.system.equals(uk.nhs.england.provider.qedm.util.FhirSystems.NHS_GMC_NUMBER)) {
